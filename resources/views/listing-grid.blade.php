        ...
        @foreach($student as $item)
          <div class="col-md-4 grid_listing">
            ...
            <div class="product-listing-m gray-bg">
              <div class="product-listing-img"> <a href="{{ url('get-id/'.$item->id) }}"><img src="{{ asset('uploads/students/'.$item->upload1) }}"  alt="image" width="100px" height="200px"/> </a>
              ...
              <div class="product-listing-content">
                <h5><a href="#">{{$item->vehicle_title}} </a></h5>
