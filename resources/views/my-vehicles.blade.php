        ...
        <div class="profile_wrap">
          ...
          <div class="my_vehicles_list">
            ...
            @foreach($student as $item)
              <li>
                <div class="vehicle_img"> <a href="{{ url('get-id/'.$item->id) }}"><img src="{{ asset('uploads/students/'.$item->upload1) }}" alt="image" width="200px" height="100px"></a> </div>
                ...
                <div class="vehicle_status"> 
                  ...
                  <a href="deleteRecord/{{$item->id}}"><i class="fa fa-trash" aria-hidden="true"></i></a> </div>
              </li>
              @endforeach
