	...
	<div class="row header-row desktop">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="nav navbar-nav">
              ...
              <li><a href="{{url('home2')}}">Home Page 1</a></li>
            ...
            <ul class="commentlist">
              <li class="comment">
                <div class="comment-body">
                  <div class="comment-author"> <img class="avatar" src="{{url('assets/images/comment-author-1.jpg')}}" alt="image"> <span class="fn">DereckNency Paul</span> </div>
              ...
              <li class="comment">
                <div class="comment-body">
                  <div class="comment-author"> <img class="avatar" src="{{url('assets/images/comment-author-2.jpg')}}" alt="image"> <span class="fn">John Smith</span> </div>
                  <div class="comment-meta commentmetadata"> <a href="#">April 23, 2016 at 12:52 pm</a> </div>
                  <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem</p>
                  <div class="reply"> <a href="#" class="btn btn-primary btn-xs outline"><i class="fa fa-reply" aria-hidden="true"></i> Reply</a> </div>
                </div>
                <ul class="children">
                  <li class="comment">
                    <div class="comment-body">
                      <div class="comment-author"> <img class="avatar" src="{{url('assets/images/comment-author-3.jpg')}}" alt="image"> <span class="fn">John Smith</span> </div>
                      <div class="comment-meta commentmetadata"> <a href="#">April 23, 2016 at 12:52 pm</a> </div>
                      <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem</p>
                      <div class="reply"> <a href="#" class="btn btn-primary btn-xs outline"><i class="fa fa-reply" aria-hidden="true"></i> Reply</a> </div>
                    </div>
      ...
      <aside class="col-lg-3 col-md-4">
        ...
        <div class="sidebar_widget">
          ...
          <div class="popular_post">
            <ul>
              <li>
                <div class="popular_post_img"> <a href="#"><img src="{{url('assets/images/post_200x200_1.jpg')}}" alt="image"></a> </div>
                <div class="popular_post_title"> <a href="#">At vero eos et accusamus et iusto odio dignissimos.</a> </div>
              </li>
              <li>
                <div class="popular_post_img"> <a href="#"><img src="{{url('assets/images/post_200x200_2.jpg')}}" alt="image"></a> </div>
              ...
              <li>
                <div class="popular_post_img"> <a href="#"><img src="{{url('assets/images/post_200x200_4.jpg')}}" alt="image"></a> </div>
