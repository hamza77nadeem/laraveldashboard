  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <div class="about_content row">
          <div class="col-md-5 col-sm-4 col-xs-4">
            <div class="about_img"> <img src="{{url('assets/images/about_us_img1.jpg')}}" alt="image"> </div>
          </div>
      ...
      <div class="col-md-6 col-sm-6">
        <div class="about_content row">
          <div class="col-md-5 col-sm-4 col-xs-4">
            <div class="about_img"> <img src="{{url('assets/images/about_us_img2.jpg')}}" alt="image"> </div>
          </div>
          <div class="col-md-7 col-sm-8 col-xs-8">
      ...
      <div class="col-md-6 col-sm-6">
        <div class="about_content row">
          <div class="col-md-5 col-sm-4 col-xs-4">
            <div class="about_img"> <img src="{{url('assets/images/about_us_img3.jpg')}}" alt="image"> </div>
          </div>
          <div class="col-md-7 col-sm-8 col-xs-8">
      ...
      <div class="col-md-6 col-sm-6">
        <div class="about_content row">
          <div class="col-md-5 col-sm-4 col-xs-4">
            <div class="about_img"> <img src="{{url('assets/images/about_us_img4.jpg')}}" alt="image"> </div>
          </div>
          <div class="col-md-7 col-sm-8 col-xs-8">
            <h3>Our <span>Mission</span></h3>
            <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment.</p>
...
<section class="why_choose_us section-padding gray-bg">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6">
        <div class="video_box">
          <iframe class="mfp-iframe" src="{{url('https://www.youtube.com/embed/rqSoXtKMU3Q')}}" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="team_member">
          <div class="team_img"> <img src="{{url('assets/images/our_team_1.jpg')}}" alt="image">
      ...
      <div class="col-md-4 col-sm-4">
        <div class="team_member">
          <div class="team_img"> <img src="{{url('assets/images/our_team_2.jpg')}}" alt="image">
            <div class="team_more_info">
              <div class="info_wrap">
                <p><span>Phone:</span> <a href="tel:+61-12134-567-89">+61-12134-567-89</a></p>
                <p><span>Email:</span> <a href="mailto:contact@example.com">contact@example.com</a></p>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="team_member">
          <div class="team_img"> <img src="{{url('assets/images/our_team_3.jpg')}}" alt="image">
            <div class="team_more_info">
              <div class="info_wrap">
                <p><span>Phone:</span> <a href="tel:+61-12134-567-89">+61-12134-567-89</a></p>
                <p><span>Email:</span> <a href="mailto:contact@example.com">contact@example.com</a></p>
