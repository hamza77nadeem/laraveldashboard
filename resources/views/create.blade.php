...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="{{url('assets/images/dealer-logo.jpg')}}" alt="image">
      ...
      <div class="col-md-3 col-sm-3">
        <div class="profile_nav">
          <ul>
            ...
            <li class="active"><a href="{{url('add-product')}}">Post a Vehicles</a></li>
        ...
        <div class="profile_wrap">
          ...
          <form action="{{URL('add-product')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="VehiclesTitle" type="text" name="vehicle_title" required>
            </div>
            <div class="form-group">
              <label class="control-label">Select Make</label>
              <div class="select">
                <select class="form-control white_bg" name="brand" required>
            ...
            <div class="form-group">
              ...
              <div class="select" name="model" required>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control white_bg" rows="4" name="vehicle_desc" required></textarea>
            </div>
            <div class="form-group">
            ...
            <!-- <div class="form-group">
              <label class="control-label">Upload Images  ( size = 900 x 560 )</label>
                  ...
                  <input type="file" name="upload2" required>
            ...
            <div class="form-group">
              <label class="control-label">Upload Images  ( size = 900 x 560 )</label>
                  ...
                  <input type="file" name="upload3" required>
            ...
            <div class="form-group">
              <label class="control-label">Upload Images  ( size = 900 x 560 )</label>
                  ...
                  <input type="file" name="upload4" required>
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="year" type="text" name="model_year" required>
            </div>
            
            <div class="form-group">
              <label class="control-label">KMs Driven</label>
              <input class="form-control white_bg" id="kws" type="text" name="km" required>
            </div>
            <div class="form-group">
              <label class="control-label">Fuel Type</label>
              <input class="form-control white_bg" id="fuel" type="text" name="fuel_type" required>
            </div>
            <div class="gray-bg field-title">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="engien" type="text" name="engine_type" required>
            </div>
            <div class="form-group">
              <label class="control-label">Engine Description</label>
              <input class="form-control white_bg" id="engien-description" type="text" name="engine_desc" required>
            </div>
            <div class="form-group">
              <label class="control-label">No. of Cylinders</label>
              <input class="form-control white_bg" id="cylinders" type="text" name="no_of_cylinder" required>
            </div>
            
            <div class="form-group">
              <label class="control-label">Mileage-Highway</label>
              <input class="form-control white_bg" id="mileage-h" type="text" name="mileage_highway" required>
            </div>
            <div class="form-group">
              <label class="control-label">Fuel Tank Capacity</label>
              <input class="form-control white_bg" id="capacity" type="text" name="fuel_tank" required>
            </div>
            <div class="form-group">
              <label class="control-label">Seating Capacity</label>
              <input class="form-control white_bg" id="s-capacity" type="text" name="seating_capacity" required>
            </div>
            ...
            <div class="vehicle_accessories">
              <div class="form-group checkbox col-md-6 accessories_list">
                <input id="air_conditioner" type="checkbox" value="Air Conditioner" name="air_conditioner" required>
                <label for="air_conditioner">Air Conditioner</label>
              </div>
              <div class="form-group checkbox col-md-6 accessories_list">
                <input id="door" type="checkbox" value="Power Door Locks" name="power_door" required>
                <label for="door">Power Door Locks</label>
              </div>
              <div class="form-group checkbox col-md-6 accessories_list">
                <input id="antiLock" type="checkbox" value="AntiLock Braking System" name="antilook" required>
                <label for="antiLock">AntiLock Braking System</label>
              </div>
              <div class="form-group checkbox col-md-6 accessories_list">
                <input id="brake" type="checkbox" value="Brake Assist" name="brake" required>
                <label for="brake">Brake Assist</label>
              </div>
              <div class="form-group checkbox col-md-6 accessories_list">
                <input id="steering" type="checkbox" value="Power Steering" name="Steering" required>
                <label for="steering">Power Steering</label>
              </div>
              
              <div class="form-group checkbox col-md-6 accessories_list">
                <input id="passenger_airbag" type="checkbox" value="Passenger Airbag" name="Airbag" required>
                <label for="passenger_airbag">Passenger Airbag</label>
              </div>
              <div class="form-group checkbox col-md-6 accessories_list">
                <input id="player" type="checkbox" value="CD Player" name="Player" required>
            ...
            <div class="form-group">
              <label class="control-label">Select Make</label>
              <div class="select">
                <select class="form-control white_bg" name="car" required>
